...
ADD   --chown=was:0 http://dev-nexus.fircosoft.net/service/local/repositories/central/content/com/oracle/ojdbc/ojdbc8/19.3.0.0/ojdbc8-19.3.0.0.jar  /opt/IBM/WebSphere/AppServer/lib/ojdbc8-19.3.0.0.jar
