...
newProvider = AdminConfig.create('JDBCProvider', scope, [
    ['name', 'docker-mssql-jdbc-provider'],
    ['classpath', '/opt/IBM/WebSphere/AppServer/lib/mssql-jdbc-8.2.0.jre8.jar'],
...
newds = AdminConfig.create('DataSource', newProvider, [
    ...
    ['description', 'MS SQLServer DataSource for Continuity WEBUI Docker']
])
