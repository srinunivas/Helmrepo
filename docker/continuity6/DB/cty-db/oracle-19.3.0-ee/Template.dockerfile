...
ENV SQL_MAIN_URI={{deps.sqlmain.uri}}
ENV SQL_MAIN_VERSION={{deps.sqlmain.version}}


# Copy "static" files
# ----------
USER oracle
RUN mkdir /home/oracle/sqlmain
...
# ----------
COPY {{deps.sqlmain.installpath}}/* /home/oracle/sqlmain/
