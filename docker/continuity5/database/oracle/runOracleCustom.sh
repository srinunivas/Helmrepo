...
# BEGIN : Customized part from original file runOracle.sh
if [ ! -z "${DOCKER_BUILD}" ]; then
   # Explicitly stop the dataserver here when building the image
   _kill;
else
...
# END : Customized part from original file runOracle.sh
